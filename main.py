...
def main():
    ...
    parser.add_argument("--chapters", type=str, help="Введите главы которые необходимо скачать. Можно указывать необходимые главы через запятую, либо же указать диапазон. Пример: 1, 2, 3:10. Главное указывать без пробелов иначе выдаст ошибку. Если оставить это значение пустым, тогда скачаются все главы.")
